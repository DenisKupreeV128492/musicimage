...
public class Main {
    ...
    private static final String IN_FILE_TXT = "C:\\проекты\\music image\\src\\inFile.txt";
    private static final String OUT_FILE_TXT = "C:\\проекты\\music image\\src\\outFile.txt";
    private static final String PATH_TO_MUSIC = "src\\com\\company\\music";

    private static final String IN_FILE_TXT2 = "C:\\проекты\\music image\\src\\inputImages.txt";

    private static final String OUT_FILE_TXT2 = "C:\\проекты\\music image\\src\\outImages.txt";
    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader inFile = new BufferedReader(new FileReader(IN_FILE_TXT));
            ...
            while ((Url = inFile.readLine()) != null) {
                ...
                Pattern email_pattern = Pattern.compile("\\/\\/ru.hitmotop.com\\/get\\/music\\/[\\w./\\-]+");
        ...
        try (BufferedReader inFile = new BufferedReader(new FileReader(IN_FILE_TXT2));
            ...
            while ((Urle = inFile.readLine()) != null) {
                ...
                Pattern email_pattern = Pattern.compile("\\/\\/akspic.ru\\/album\\/7680x43202[\\w./\\-\\$\\?\\_\\%\\~]+");
                Matcher matcher = email_pattern.matcher(result);
                int i = 1;
                while (matcher.find() && i <= 5) {
                    outFile.write("https:" + matcher.group() + "\r\n");
